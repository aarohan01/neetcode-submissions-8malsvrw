class Solution:
    def largestRectangleArea(self, heights: List[int]) -> int:
        ...
        ### Bruteforce ###
        # Loop for each i, maxarea is either (height of i) or (the minheight from i till each j * distance)
        # Time: O(n^2)
        # Space: O(1)
        '''
        maxarea = 0
        ...
        # Case 1: current is lower or equal than previous -> keep popping and calculate area then add height and starting index
