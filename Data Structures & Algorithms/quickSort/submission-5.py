...
class Solution:
    ...
    def quickSortHelper(self,pairs,s,e):
        ...
        ###### The most inportant part, all the elements less are to left only if any more then swap
        #### If swapped increment the filled 
        ### SO THE SWAPPING IS NOT WITH THE PIVOT IT IS WITH THE FILLED POINTER
        # At the end we put pivot in middle using the filled pointer so all elements to left of pivot are 
        # smaller and right are larger
        ...
        pairs[filled],pairs[e] = pairs[e],pairs[filled]
