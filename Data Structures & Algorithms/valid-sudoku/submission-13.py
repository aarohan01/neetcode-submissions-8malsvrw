class Solution:
    def isValidSudoku(self, board: List[List[str]]) -> bool:
        ...
        ### Bit mask solution is best as it avoids math and checks all in one go ###
        ## If using the set version instead create 3x3 list of set and use r//3,c//3 key ##
        ...
        for r in range(9):
            for c in range(9):
                ...
                ''' 
                Value to Index conversion here is unnecessary.
                Even if it maps 1 to 0 it will be same for every number.
                So can directly do with val 
                index = val - 1
                '''
                bitval = 1 << val
