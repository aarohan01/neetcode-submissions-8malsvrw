...
class Solution:
    def buildTree(self, preorder: List[int], inorder: List[int]) -> Optional[TreeNode]:
        ...
        # Idea is that search root in preorder, then get index of that in inorder, left of 
        # that index is the left subtree and right is right subtree then recursively get those 
        # until leaf node reached -  when preorder and 
        ...
        # apart from current root index i.e mid all left index required.
