class Solution:
    def maxAreaOfIsland(self, grid: List[List[int]]) -> int:
        ...
        ## Recursion type - Mutate state use nonlocal area and update it to get area of island 
        # Use it to set maxarea
        # Idea is to start from cell with 1 value.
        # Return if base case of failure
        # Mark or add to visit set if value 1, in
