class Solution:
    def validTree(self, n: int, edges: List[List[int]]) -> bool:
        ...
        ### DFS single source + parent for cycle detection ##
        # Then check lenghth of visit set and n for component #

        ### DSU - need to check if cycle and one component - optimal ###
        ...
        # Time is practically O(V+E) amortized V is constant due to inverse ackerman and path compression
