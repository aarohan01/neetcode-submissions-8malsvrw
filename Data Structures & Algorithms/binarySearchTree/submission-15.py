#### IMP NOTE #####
## Why is closure or private method required here for recursion ?
# It is because the method given is insert(key,val) but we need insert(node,key,val) 
# so we either create a closure method or a separte method ( usually this is with _ as private ) outside.
        ...
        def removeHelper( node, key ):
            ...
            if key < node.key:
                ...
                if not node.left:
                    ...
                    ### Right Subtree MinNode i.e. leftmost ###
                    curr = node.right 
                    while curr and curr.left:
                        curr = curr.left
                    minNode = curr 
