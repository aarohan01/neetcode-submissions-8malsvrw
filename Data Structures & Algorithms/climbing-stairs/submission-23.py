class Solution:
    def climbStairs(self, n: int) -> int:
        ...
        return climb(0)
        '''
        ### Bottom up - Forward ### from the above top down 
        '''
        memo = [None]*(n+2)
        ...
        memo = [1,0]
        for i in range(n-1,-1,-1):
            memo[0],memo[1] =  memo[0] + memo[1], memo[0]
        return memo[0]
        '''
        ...
        # To go to 1 is 1 way to go to n ==2 is two ways 1,1 and 2 directly 
        memo[1] =  1
        memo[2] =  2
