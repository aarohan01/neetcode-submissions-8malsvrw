...
class Solution:
    def mergeTwoLists(self, list1: Optional[ListNode], list2: Optional[ListNode]) -> Optional[ListNode]:
        ...
        # we do not have to traverse the entire linked list 
        # Once a list is finished, i.e don't have to place cur pointer to end, just attach once.
        # Time: O(m+n)
        # Space: O(1)
        ## Important - Starting with a dummy node
