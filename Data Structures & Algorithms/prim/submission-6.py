...
class Solution:
    def minimumSpanningTree(self, n: int, edges: List[List[int]]) -> int:
        ...
        # To store path if required just store the parent in heap and careful to not add fake parent None
		...
		## Path ##
        MST = []
        # Cost to reach 1st Node is 0, and any node can be selected selecting 0, parent None
        heapq.heappush(minHeap, (0, 0, None))
